<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.dumb.dao.DabaseOperation,java.sql.Connection,java.sql.PreparedStatement,java.sql.ResultSet,java.util.List,java.sql.Connection, com.dumb.model.Book" %>
...
String sql = "SELECT title, author, price, publication FROM book";
...
ResultSet resultSet = statement.executeQuery();
   ...
   float price = resultSet.getFloat("price");
        ...
        Book book = new Book (title, author, price, publication);
